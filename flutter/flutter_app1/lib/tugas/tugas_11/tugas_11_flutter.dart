...
import 'package:flutter_app1/tugas/tugas_11/db_helper_11.dart';
import 'package:flutter_app1/tugas/tugas_11/participant_model.dart';
import 'package:flutter_app1/tugas/tugas_11/text_form_field_11.dart';
import 'package:intl/intl.dart';

class TugasSebelasFlutter extends StatefulWidget {
  static String id = "/tugas_11";
...
class _TugasSebelasFlutterState extends State<TugasSebelasFlutter> {
  void loadData() async {
    final data = await DbHelperSebelas.getAllData();
    if (data.isNotEmpty) {
      setState(() {
  ...
  void insertData() async {
    if (_formKey.currentState!.validate()) {
      await DbHelperSebelas.insertData(
        ParticipantModel(
              ...
              children: [
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ParticipantModel participant = listParticipant[index];
                    return Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Divider(thickness: 4, color: Color(0xffB6B09F)),
                              SizedBox(height: 8),
                              Text(
                                "Nama Peserta :",
                                style: TextStyle(
