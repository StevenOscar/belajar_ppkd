...
class Species {
  ...
  factory Species.fromJson(Map<String, dynamic> json) => Species(name: json["name"], url: json["url"]);
...
class Cries {
  ...
  factory Cries.fromJson(Map<String, dynamic> json) => Cries(latest: json["latest"], legacy: json["legacy"]);
...
class Move {
  ...
  Map<String, dynamic> toJson() => {
    ...
    "version_group_details":
        versionGroupDetails == null ? [] : List<dynamic>.from(versionGroupDetails!.map((x) => x.toJson())),
  };
}
...
class VersionGroupDetail {
  ...
  VersionGroupDetail({this.levelLearnedAt, this.moveLearnMethod, this.order, this.versionGroup});
...
class GenerationV {
  ...
  factory GenerationV.fromJson(Map<String, dynamic> json) =>
      GenerationV(blackWhite: json["black-white"] == null ? null : Sprites.fromJson(json["black-white"]));
...
class GenerationI {
  ...
  Map<String, dynamic> toJson() => {"red-blue": redBlue?.toJson(), "yellow": yellow?.toJson()};
}
...
class GenerationIi {
  ...
  Map<String, dynamic> toJson() => {"crystal": crystal?.toJson(), "gold": gold?.toJson(), "silver": silver?.toJson()};
}
...
class OfficialArtwork {
  ...
  factory OfficialArtwork.fromJson(Map<String, dynamic> json) =>
      OfficialArtwork(frontDefault: json["front_default"], frontShiny: json["front_shiny"]);
...
class GenerationVii {
  ...
  Map<String, dynamic> toJson() => {"icons": icons?.toJson(), "ultra-sun-ultra-moon": ultraSunUltraMoon?.toJson()};
}
...
class DreamWorld {
  ...
  factory DreamWorld.fromJson(Map<String, dynamic> json) =>
      DreamWorld(frontDefault: json["front_default"], frontFemale: json["front_female"]);
...
class GenerationViii {
  ...
  factory GenerationViii.fromJson(Map<String, dynamic> json) =>
      GenerationViii(icons: json["icons"] == null ? null : DreamWorld.fromJson(json["icons"]));
...
class Type {
  ...
  factory Type.fromJson(Map<String, dynamic> json) =>
      Type(slot: json["slot"], type: json["type"] == null ? null : Species.fromJson(json["type"]));
